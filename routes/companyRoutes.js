...
router.get("/productentry/productdetail/:brandId",  getProductDetails);// get all product details of logged in user
router.put("/productentry/productdetail/:id",  upload.array("images", 5), updateProductDetail);// update product detail
router.delete("/productentry/productdetail/:id",  deleteProductDetail);// delete product detail
router.get("/orders",  getCompanyOrders);// ✅ get company orders
router.put("/order/:id/deliver",  markDelivered);// ✅ mark delivered
